...
func init() {
  ...
  },
  {
    "code": "CHE",
    "decimals": 2,
    "name": "WIR NameEuro (complementary currency)",
    "number": "947"
  },
  {
    "code": "CHF",
...
`
	...
	for index := range parsed {
		iso4217 := parsed[index]
		if len(iso4217.Code) == 3 {
			CurrencyByCode[iso4217.Code] = iso4217
		}
		if len(iso4217.Name) > 0 {
			CurrencyByName[iso4217.Name] = iso4217
		}
	}
}
